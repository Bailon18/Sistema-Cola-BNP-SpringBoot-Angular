...
CREATE TABLE IF NOT EXISTS `gestionturnosdb`.`clientes` (
  ...
  `digito_verificador` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gestionturnosdb`.`tickets` (
  ...
  INDEX `fk_tickets_servicios1_idx` (`servicios_id` ASC) VISIBLE,
  INDEX `fk_tickets_modulos1_idx` (`modulos_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tickets_servicios1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tickets_modulos1`
...
CREATE TABLE IF NOT EXISTS `gestionturnosdb`.`atenciones` (
  ...
  INDEX `fk_atenciones_modulos1_idx` (`modulos_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_atenciones_modulos1`
    FOREIGN KEY (`modulos_id`)
    REFERENCES `gestionturnosdb`.`modulos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
